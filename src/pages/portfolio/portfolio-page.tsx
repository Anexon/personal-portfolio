      ...
      <div className="posts-container">
        <div className="post-card">
          <div
            ...
            style={{ backgroundImage: "url('/resources/medium_1.png')" }}
          ></div>
          <div className="post-body">
            <h1>
              <a href="https://medium.com/puntotech/c%C3%B3mo-usar-d3-con-webcomponents-44ea4a95a238">
                Cómo usar D3 con WebComponents
              </a>
            </h1>
            <p>
              La visualización de datos es un prisma de muchas caras; donde unos
              ven un simple gráfico de barras otros ven una clara tendencia de
              crecimiento, un objetivo cumplido o incluso un simple .json de
              datos sin contexto.
            </p>
            <small>
        ...
        <div className="post-card">
          ...
          <div className="post-body">
            ...
            <p>
              ...
              accesible por los principales frameworks de desarrollo web. Esto
              es una gran ventaja para unir elementos visuales de varios
              proyectos y estandarizar su uso, reciclar código, html, css, etc..
            </p>
            <small>
              <a href="https://medium.com/@benru">Rubén Triviño</a> en{" "}
              <a href="https://medium.com/puntotech">PuntoTech</a>
